...
# To use the files created in transpositionFileCipherMB.py must be in the
# same folder.

import time, os, sys, transpositionDecryptMB, detectEnglishMB
...
def hackTransposition(message):
    ...
    for key in range(1, len(message)):
        ...
        decryptedText = transpositionDecryptMB.decryptMessage(key, message)
        englishPercentage = round(detectEnglishMB.getEnglishCount(decryptedText) * 100, 2)
