...
# Can be used to determine if a number is a prime number.
# Also can be used to generate large primbe numbers.

# To use, import primeNumMB then to check if a number is prime use
# primeNumMB.isPrime(x). To generate a large prime number, use
# primeNumMB.generateLargePrime().
