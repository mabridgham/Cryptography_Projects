...
import re, copy, pyperclip, simpleSubCipherMB, wordPatterns,  makeWordPatterns
...
def addLettersToMapping(letterMapping, cipherword, candidate):
    ...
    # The cipherword parameter is a string vlaue of the ciphertext word.
    # The candidate parameter is a possible English word that the
    # cipherword could decrypt to.

    # This function adds the letters in the candidate as potential
    # decription letters for the cipherletters in the cipherletter mapping.
...
def removeSolvedLettersFromMapping(letterMapping):
    ...
    # to ['M']. Note that now that 'A' now maps to only one letter, we can
    ...
    while loopAgain:
        ...
        # and only on possible mapping in letterMapping:
...
def decryptWithCipherletterMapping(ciphertext, letterMapping):
    ...
    return simpleSubCipherMB.decryptMessage(key, ciphertext)
